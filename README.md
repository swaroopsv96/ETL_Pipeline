...
You can find the starter file at <https://fiber-challenges.s3.amazonaws.com/dump.tar.gz>.
...
1. Use Node.js's Streams API to download `https://fiber-challenges.s3.amazonaws.com/dump.tar.gz` from the cloud; save it to the local file system in the `tmp/` folder.
